...
import Lesson_8.Homework_8.configuration.ApplicationGlobalState;
import Lesson_8.Homework_8.dto.WeatherResponse;
import Lesson_8.Homework_8.enums.Periods;
import Lesson_8.Homework_8.entity.WeatherData;
import Lesson_8.Homework_8.repository.DatabaseRepository;
import Lesson_8.Homework_8.repository.DatabaseRepositorySQLiteImpl;
...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    public void getWeather(Periods periods) throws IOException, SQLException {
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            System.out.println("Сейчас в " + ApplicationGlobalState.getInstance().getSelectedCity() +
